angular.module('app').controller('ResultController', ['$scope', 'NgTableParams', 'AdService',
    function ($scope, NgTableParams, AdService) {
        'use strict';
        ...
        $scope.selectCity = function($item, $model) {
            $scope.selectedCity = ($model) ? $model.value: $model;
        };
